...
if __name__ == "__main__":
    # Everything below here is the original notebook-style script body:
    # data loading/download, model instantiation, training run, evaluation,
    # interactive GUI, and weight export. Guarded so that `train()` above can
    # be imported (e.g. by scripts/train_hybrid.py) without triggering any of
    # this side-effecting code -- no logic or config values changed below.
